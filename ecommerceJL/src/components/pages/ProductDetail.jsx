...
import '../productDetail/style/productDetail.css'
			...
			<div className='slider'>
				...
				<div className={`slider__container ${classImg[indexClass]}`}>
					{productInfo?.images.map(url => (
						<img key={url.id} src={url.url} alt='' className='slider__imgs' />
					))}
				</div>
				...
				<div className='puntos__container'>
					<div
						...
						className={indexClass === 0 ? 'puntos puntos__active' : 'puntos'}
					></div>
					<div
						onClick={() => setIndexClass(1)}
						className={indexClass === 1 ? 'puntos puntos__active' : 'puntos'}
					></div>
					<div
						onClick={() => setIndexClass(2)}
						className={indexClass === 2 ? 'puntos puntos__active' : 'puntos'}
					></div>
				</div>
			</div>
